SELECT 
    ...
    event_location.country AS country, event_location.province_state AS 'province/state', 
    event_perpetrator_details.group_name1 AS 'major perpetrator', 
    event_target_victim_details.target1_id AS target, 
    CONCAT(event_weapon_details.weapon1_type, 
    ...
    WHERE event_details.event_year = ?;